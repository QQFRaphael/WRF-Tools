    ...
    do ib = 1, nband
       do fc = 1,num_nourbanc
          ...
          if (coszen(c) > 0._r8) then
             ...
             !QQF
             if( ( (lat(g).ge.(35.0*3.14/180.0) .and. lat(g).le.(40.0*3.14/180.0).and.&
              lon(g).ge.(70.0*3.14/180.0) .and. lon(g).le.(80.0*3.14/180.0)) .or. &
              (lat(g).ge.(30.0*3.14/180.0) .and. lat(g).le.(35.0*3.14/180.0).and.&
              lon(g).ge.(75.0*3.14/180.0) .and. lon(g).le.(90.0*3.14/180.0)) .or. &
              (lat(g).ge.(25.0*3.14/180.0) .and. lat(g).le.(30.0*3.14/180.0).and.&
              lon(g).ge.(85.0*3.14/180.0) .and. lon(g).le.(95.0*3.14/180.0)) ) & 
              .and.(mon.eq.9 .or. mon.eq.10 .or. mon.eq.11))  then
!                   albgrd(c,ib) = 0.9
!                   albgri(c,ib) = 0.9 
                   albgrd(c,ib) = albsod(c,ib)*(1._r8-frac_sno(c)) + albsnd(c,ib)*frac_sno(c)
                   albgri(c,ib) = albsoi(c,ib)*(1._r8-frac_sno(c)) + albsni(c,ib)*frac_sno(c)    
