...
########################################################################
#
# this ksh script is used to generate obs of little_r formate from
# micaps format(diamond 2)
#	one only need to give Beijing time, UTC and the path of micaps sounding
#
# written by Bolei Yang, NUIST 2013,6
#
########################################################################


export BJ_time=12072208
export UTC=12072200
export MPS_PATH=/gpfs/fs1/home/student/ybl/beijing/2024/high/


cat << EOF > mps2_littler.f90
PROGRAM MAIN
IMPLICIT NONE
